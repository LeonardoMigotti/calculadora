    ...
    return AppBar(
      ...
      actions: <Widget>[
        IconButton(
            ...
            onPressed: () {
              Share.share('https://github.com/LeonardoMigotti');
            })
      ],
    );
  }
    ...
    return Expanded(
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(color: Colors.white, fontSize: 52, fontFamily: 'Calculator'),
        ),
      ),
    );
  }
    ...
    return Expanded(
      child: Container(
        ...
        child: Text(
          text ?? '0',
          textAlign: TextAlign.end,
          style: TextStyle(color: Colors.grey, fontSize: 40, fontFamily: 'Calculator'),
        ),
      ),
    );
  }
  ...
  Widget _buildKeyboardLine1() {
    return Expanded(
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _buildButton(label: 'AC', color: Colors.black),
          _buildButton(label: 'DEL', color: Colors.black),
          _buildButton(label: '%', color: Colors.black),
          _buildButton(label: '/', color: Colors.black)
        ],
      ),
    );
    ...
    return Expanded(
      child: Row(
        ...
        children: [
          ...
          _buildButton(label: 'x', color: Colors.black)
        ],
      ),
    );
  }
